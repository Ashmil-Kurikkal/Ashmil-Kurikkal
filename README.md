# 🥷 About :
💻 I'm currently pwning on HTB, no time for dev (nothin kewl) <br>🫂 Looking to collaborate on small projects. <br>🤖 Seeking help with :<br>• Finding free open learning sources for red teaming and cybersec. <br>• Adding more cool features to my telegram bot. <br>👣 I'm currently learning C Programming & Cybersec. <br>📈 Git-ing since print ("hello world") 
